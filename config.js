...
module.exports = {
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'Raganork~a5277fc0a5b0befa319abc5841012dc6:65672b65692b36526759673d').trim() || '',
    ...
    BOT_NAME: process.env.BOT_NAME || 'Kevin',
